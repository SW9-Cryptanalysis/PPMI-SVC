...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(
		description="Visualize cipher symbol embeddings using t-SNE.",
	...
	print(f"Generating/Loading embeddings from: {args.filepath}...")
	...
	save_path = f"{base_name}-{args.function}.png"
	...
	if args.function == 'simple':
		selected_function = plot_embeddings_2d
		
	elif args.function == 'cluster':
		selected_function = plot_embeddings_2d_cluster
		kwargs['min_cluster_size'] = 2
		
	elif args.function == 'vc':
		selected_function = plot_embeddings_2d_vc
		
	print(f"Running plot function: {selected_function.__name__}")
	selected_function(**kwargs)
	print("Plotting complete and saved.")